...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<YacthManager>().As<IYacthService>().SingleInstance();
            builder.RegisterType<EfYacthDal>().As<IYacthDal>().SingleInstance();
            ...
            builder.RegisterType<YacthImageManager>().As<IYacthImageService>().SingleInstance();
            builder.RegisterType<EfYachtImageDal>().As<IYacthImageDal>().SingleInstance();
